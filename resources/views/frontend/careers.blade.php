...
<html>
		...
		<body id="body-main">
			...
			<section class="sec_ban" id="career-banner">
				<div class="home-ban">
					<div class="rs-img">
					<img src="assets/images/careers.jpg" class="img-fluid rs-banner" alt="home banner"></div>
					<div class="over-h2">
						<h2>Careers</h2>
												...
												<div class="col-sm-12">
													<div class="blog-cat">
														<a href="careers-view.php">
															...
															<p>Location : Delhi, NCR Educational Background: B.E, B. Tech, B.SC in Information Security, CSC, ECE, IT Certifications…</p>
														</a>
						...
						<div class="col-md-4 sider-blog pr-0">
							...
							<div class="clearfix mb-4">
								<div class="form quick-form bg-scheme mb-4 text-center">
									...
									<form name="form_pages" id="form_pages" action="http://codecnetworks.in/codec/course_resources">
										...
										<button class="btn btn-success btn-lg btn_save btn_action" data-stype="back"  title="Click to Submit">
							...
							<div class="offer-sec-inn">
								<div class="view_blog">
									...
									<ul>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">Penetration Tester / Exploiter</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">Information Security Engineer</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">Telecom Security Consultant / Mobile Application Security</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">Penetration Tester</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">Senior Engineer - Professional Services</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">Security Operations/VAPT/Malware Detections/Incident Investigations</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i><a href="careers-view.php">Application Security</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">VAPT Analyst , Penetration Testing, Vulnerability Assessment</a></li>
										<li><i class="fa fa-caret-right" aria-hidden="true"></i> <a href="careers-view.php">VAPT Analyst , Penetration Testing, Vulnerability Assessment</a></li>
									</ul>
								</div>
							</div>
				...
				<div class="container">
					<div class="col-sm-12 txt-center centered-txt-banner">
						<div class="inner-text-div">
							<h3 class="text-center text-white">“With CYBARWIND, you get the best of both worlds—the fast pace, innovative world of a start-up, but with the funding and talent that allows the company to have a bigger impact on the next generation of data technology than most of the large legacy IT vendors.” — Cloudera employee</h3>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="col-md-10 offset-sm-1 pd_34 text-center team-sec-new">
						<div class="title section mb-5">
							...
							<p>There are many exciting and innovative career opportunities at Cloudera. Which one is right for you? We invite you to take a closer look at some of these great opportunities and see where you fit in best.
							</p>
						</div>
			...
			<section class="sec-wrap-cod bg-color-gray">
				<div class="container">
					<div class="col-sm-12">
						...
						<h5>Look no more!</h5>
						<p>At Edureka, we have thousands of experienced professionals as well as freshers, with new skills looking for a career changeover. Connect with us to get the right talent you are looking for!</p>
						<p>Our students are proficient professionals who have taken the initiative to learn essential new skills through our career-oriented program.</p>
						...
						<p>Update us on your open positions and we'll put them in front of an ocean of talented and qualified practitioners. We’re happy to provide you with more details about the hiring process. Just fill in the form and one of our representative will get back to you.</p>
					</div>
				</div>
			</section>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" name="designation" class="form-control" placeholder="Job Title or designation">
									</div>

									<div class="form-group">
										<input type="text" name="profile" class="form-control" placeholder="Desired candidate profile">
									</div>
									<div class="form-group">
