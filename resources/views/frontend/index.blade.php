...
<body class="home-page" id="mian-body">
   ...
   <div class="html5-banner parbase section mhspace" id="banner">
      <div class="video-container video500 mk-black">
         ...
         <video autoplay="" loop="" muted="" playsinline="" class="row full-banner banner center-mk-vid"
            ...
            <source src="/assets/video/solutions-webbg-grow-v1-small.mp4" type="video/mp4">
            <source src="/assets/video/solutions-webbg-grow-v1-small.mp4" type="video/webm">
         ...
         <div class="video-content container">
            ...
            <div class="text parbase section">
               <div>
                  <div class="inner-text-div1  ">
                     <h1 style="text-align: center;">Drive customer engagement, reduce attrition, and uncover business
      ...
      <div class="container p40">
         <div class="row">
            <div class="col-md-4">
               <div class="empower-industry-box">
                  <div class="cn-hover-box">
                     <div class="cn-hover-img"> <img src="/assets/images/vapt-services.jpg"> </div>
                     <div class="cn-content">
                        <p>Services to ensure the Integrity of Information Systems, Softwares & Applications, block
                           illegal access and protect organizations against data theft, productivity loss and fraud.
                        </p>
                     </div>
                  </div>
                  <div class="cn-main-content">
                     <h3>Vulnerability Assesement &amp; Penetration Testing</h3>
                     <p>Services to ensure the Integrity of Information Systems, Softwares & Applications, block illegal
            ...
            <div class="col-md-4">
               <div class="empower-industry-box">
                  <div class="cn-hover-box">
                     <div class="cn-hover-img"> <img src="/assets/images/forensic-seervices.jpg"> </div>
                     <div class="cn-content">
            ...
            <div class="col-md-4">
               <div class="empower-industry-box">
                  <div class="cn-hover-box">
                     <div class="cn-hover-img"> <img src="/assets/images/soc-services.jpg"> </div>
                     <div class="cn-content">
                  ...
                  <div class="cn-main-content">
                     ...
                     <p>Provides round-the-clock proactive event monitoring with prioritized alert notification & threat
                        mitigation.
                     </p>
                        ...
                        <div class="row">
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Security focused evaluation of your network-based computing environment, from both
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>Identifies and exploits network infrastructure vulnerabilities and validate result
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our comprehensive security assessment framework focuses to evaluate and analyse
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>We simulates real-world attacks to provide a real time assessment of vulnerabilities
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>We go beyond looking at API and web vulnerabilities to examine the risk of the
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>Identifies and locate security risk and misconfigurations that have been ignored
                        ...
                        <div class="row">
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>We evaluate current IT governance, risk management and compliance structures for
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>We demonstrate business is compliant and is taking all necessary measures to secure
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our deep portfolio enables businesses to reduce the time, cost and complexity of
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our experts ensure the right processes, people and technology are in place to meet
                                    business respective goals in agreement with industry standards like ISO 20000
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our key offerings involve and improve incident response preparedness plan and
                        ...
                        <div class="row">
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our Managed Firewall/UTM solution provides monitoring, administration & maintenance
                                    of gateway level security along with policy supervision, upgrades and patch
                                    deployment.
                                 </p>
                              </div>
                           </div>
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>We offers a wide range of EPS solutions which integrates new and innovative
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our Data Loss Prevention (DLP) comes with Unique capture technology to safeguards
                                    intellectual property and protect sensitive data in-line with compliance.
                                 </p>
                              </div>
                           </div>
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our Data Encryption solution help businesses looking to bolster their data security,
                                    increase customer confidence and ensure compliance with data protection laws.
                                 </p>
                              </div>
                           </div>
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our Mobile Device Management (MDM) Solutions allows business to secure and manage
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>We provides an intuitive solution that filters unwanted software and malware from
                                    user-initiated Web/Internet traffic and enforces corporate and regulatory policy
                                    compliance.
                                 </p>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our comprehensive approach for malware analysis gains an deeper understanding of
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our key services help businesses to traces financial trails and key data from
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our digital forensic examiners investigates and examine evidences related to email
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>technology, our experts provide the resources and methods to recover inaccessible
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>We secure an exact copy of a storage device by investigating and restoring drive
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>Our eDiscovery consultants can assist you with the entire electronic discovery
                        ...
                        <div class="row">
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>We provide comprehensive real-time monitoring of infrastructure and round-the clock
                           ...
                           <div class="col-md-2 p5">
                              <div class="tab-content-box">
                                 ...
                                 <p>WWe rapidly response to a security incident by locating, analysing and quarantining
                                    the
                           ...
                           <div class="col-md-2 p5 ">
                              <div class="tab-content-box">
                                 ...
                                 <p>We uses a multi-tiered approach to identify the activities of different groups and
                     ...
                     <div id="mhome-slider16" class="owl-carousel owl-theme">
                        <div class="item">
                           <div class="tab-content-box">
                              <h3>Network Architecture Design Review</h3>
                              <p>Security focused evaluation of your network-based computing environment, from both
                                 an architecture and operational perspective. We provide End-to-End Information Security
                                 Solutions and Services to help our Clients secure their
                                 most critical business data assets and operate business in most secure environment We
                                 provide End-to-End Information Security Solutions and Services to help our Clients
                                 secure their
                                 most critical business data assets and operate business in most secure environment
                              </p>
                              <!--  -->
                              <div class="know-more">
                                 <a href="#">Know More</a>
                     ...
                     <div id="mhome-slider12" class="owl-carousel owl-theme">
                        <div class="item">
                           <div class="tab-content-box">
                              <h3>Network Architecture Design Review</h3>
                              <p>Security focused evaluation of your network-based computing environment, from both
                                 an architecture and operational perspective.Security focused evaluation of your
                     ...
                     <div id="mhome-slider13" class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                           <div class="tab-content-box">
                              <h3>Network Infrastructure Penetration Testing</h3>
                              <p>Identifies and exploits network infrastructure vulnerabilities and validate result
                                 with efficiently evaluate a security posture. Identifies and exploits network
      ...
      <div class="container p40 desktop-view">
         <div class="row">
            ...
            <div class="col-md-2 width238">
               <div class="empower-industry-box">
                  <div class="cn-hover-box">
                     <div class="cn-hover-img"> <img src="/assets/images/security-audit-compliance.jpg"> </div>
                     <div class="cn-content">
                        <p>Help organizations with regular and structured evaluation of compliance with the security
            ...
            <div class="col-md-2 width238">
               <div class="empower-industry-box">
                  <div class="cn-hover-box">
                     <div class="cn-hover-img"> <img src="/assets/images/managed-it-services.jpg"> </div>
                     <div class="cn-content">
                        <p>Preferred Service Partner" for corporate clients with array of customized security solutions
                  ...
                  <div class="container  mobilewidth">
                     ...
                     <div class="row">
                        <div class="col-md-2 p5 ">
                           <div class="tab-content-box">
                              <h3>Network Architecture Design Review</h3>
                              <p>Security focused evaluation of your network-based computing environment, from both an
                        ...
                        <div class="col-md-2 p5">
                           <div class="tab-content-box">
                              <h3>Network Infrastructure Penetration Testing</h3>
                              <p>Identifies and exploits network infrastructure vulnerabilities and validate result with
                        ...
                        <div class="col-md-2 p5">
                           <div class="tab-content-box">
                              <h3>Source Code Review</h3>
                              <p>Identifies and locate security risk and misconfigurations that have been ignored during
   ...
   <section class="mhspace mhspace00" id="mhome-div6">
      <div class="traing-banner desktop-view">
         <img src="/assets/images/training-domain-bg.jpg">
                           ...
                           <div class="col-md-7">
                              <div class="red-title">
                                 <p> In a world teeming with digital threats, ethical hacking emerges as a formidable
                                    ...
                                    experts who use
                                    their skills to identify vulnerabilities and strengthen security measures. Explore
                                    the realm of
                                    ethical hacking with our comprehensive courses that empower individuals and
                                    organizations to
                  ...
                  <div class="it-box">
                     ...
                     <div class="it-content">
                        <p>In a world teeming with digital threats, ethical hacking emerges as a formidable strategy to
                           fortify cyber defenses. Ethical hackers, or "white hat" hackers, are cybersecurity experts
                           who use their skills to identify vulnerabilities and strengthen security measures. Explore
                           the realm of ethical hacking with our comprehensive courses that empower individuals and
                  ...
                  <div class="tdw-box row">
                     ...
                     <div class="col-md-8">
                        <div class="feature-header">
                           ...
                           <p>A global training provider offers expertise in domains including IT, Info Sec, Service/
               ...
               <div class="tdw-box row">
                  ...
                  <div class="col-md-8">
                     <div class="feature-header">
                        ...
                        <p>Extensive and meticulous knowledge with enhanced capabilities programs are engineered for
               ...
               <div class="tdw-box row">
                  ...
                  <div class="col-md-8">
                     <div class="feature-header">
                        ...
                        <p>Develops the strong logical skills needed to detect, investigate and prevent computer crime
                           and
               ...
               <div class="tdw-box row">
                  ...
                  <div class="col-md-8">
                     <div class="feature-header">
                        ...
                        <p>Most up-to-date GRC training programs ensure to achieve required capabilities of shielding
               ...
               <div class="tdw-box row">
                  ...
                  <div class="col-md-8">
                     <div class="feature-header">
                        ...
                        <p> Knowledge programs covers the policies and practices adopted to prevent, monitor and reduce
               ...
               <div class="tdw-box row">
                  ...
                  <div class="col-md-8">
                     <div class="feature-header">
                        ...
                        <p>Based on the most integrated programs like ITIL, PMP, Prince, DevOps, Agile, Scrum necessary
                           to
               ...
               <div class="tdw-box row">
                  ...
                  <div class="col-md-8">
                     <div class="feature-header">
                        ...
                        <p>Industry specific (Aerospace, Oil, Gas, Health, Education, Medical, Energy etc) based QM
               ...
               <div class="row">
                     <div class="col-md-6 pb-4">
                        <div class="wccn-content">
                           ...
                           <p><span> We always dedicated to maintain the high values of loyalty and integrity over the
                                 years.</span>
                           </p>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6 pb-4">
                        <div class="wccn-content">
                           <h4><span><i class="fa fa-check border"></i> STRATEGIC SOLUTIONS TO INDUSTRY NEEDS</span></h4>
                           <p><span> We constantly sit with our customers on the same side of table to provide strategically
                     ...
                     <div class="col-md-6 pb-4">
                        <div class="wccn-content">
                           ...
                           <p><span> We follows strong ethics, strict code of conduct and high level of professionalism with
                     ...
                     <div class="col-md-6 pb-4">
                        <div class="wccn-content">
                           ...
                           <p><span> We continuously work on the longevity and ability to move with the times and pioneer new
                                 ways.</span>
                           </p>
                        </div>
                     </div>
                     <div class="col-md-6 pb-4">
                        <div class="wccn-content">
                           <h4><span><i class="fa fa-check border"></i> COMPREHENSIVE PROJECT MANAGEMENT</span></h4>
                           <p><span> We ensure cost effective and swift execution of project approach, processes, checklists
                                 and
                                 deliverables.</span>
                           </p>
                        </div>
      ...
      <div class="container">
         <div class="row">
            <div id="client-logo" class="owl-carousel owl-theme">
               <div class="item"> <img src="assets/images/clients/eccoincil-partnerlogo.png" class="img-fluid" alt="">
               </div>
               <div class="item"> <img src="assets/images/clients/pecb-partnerlogo.png" class="img-fluid" alt=""></div>
               <div class="item"><img src="assets/images/clients/mcafee.png" class="img-fluid" alt=""></div>
               <div class="item"><img src="assets/images/clients/being-cert-logopartner.png" class="img-fluid" alt="">
               </div>
               <div class="item"><img src="assets/images/clients/quick-heal.png" class="img-fluid" alt=""></div>
               <div class="item"><img src="assets/images/clients/shophospartnerlogo.png" alt="Owl Image"></div>
               ...
               <div class="item"><img src="assets/images/clients/kesperskypartner.png" class="img-fluid" alt=""></div>
         ...
         <div class="row">
            <div class="cn-tabs1">
               <ul id="tabs-nav4" class="desktop home-nav-v2">
                  <li><a href="#tab1116">Cybersecurity </a></li>
                  <li><a href="#tab1117">Ethical Hacking </a></li>
                  <li><a href="#tab1118">Penetration Testing </a></li>
                  <li><a href="#tab1119">Vulnerability Assessment</a></li>
                  <li><a href="#tab1110">Certification </a></li>
               </ul>
               <!-- END tabs-nav -->
               <div id="tabs-content">
                  <div id="tab1116" class="tab-content4">
                     <!--  -->
                     <div class="home-slider">
                  ...
                  <div id="tab1117" class="tab-content4">
                     <!--  -->
                     <div class="home-slider">
                  ...
                  <div id="tab1118" class="tab-content4">
                     <!--  -->
                     <!--  -->
                     <div class="home-content-tab">
                        <div class="row rowp">
                  ...
                  <div id="tab1119" class="tab-content4">
                     <!--  -->
                     <div class="home-slider">
                  ...
                  <!--  -->
                  <div id="tab1110" class="tab-content4">
                     <!--  -->
                     <div class="home-slider">
            ...
            <div class="industry-slider">
                     ...
                     <a href="#partnter3">
                        <div class="team-details">
                           <div class="team-img part-bg3">
                              <img src="assets/images/Industries/Banking-Finance-Insurance.png" alt="" title="">
                     ...
                     <a href="#partnter9">
                        <div class="team-details">
                           <div class="team-img part-bg9">
                              <img src="assets/images/Industries/Industruies-Manufacturing.png" alt="" title="">
               ...
               <div class="partner-mian">
                  ...
                  <div class="partner-logo" id="partnter1" style="display:block">
                     ...
                     <ul>
                        <li>
                           <img src="https://www.cybarwind.com/demo/assets/images/clients/ncdc-client-logo.jpg" alt="">
                        </li>
                        <li>
            ...
            <div id="client-testimonials" class="owl-carousel owl-theme owl-arrow">
               ...
               <div class="item">
                  <div class="ceh-testo-box" data-target="client-testimonials-popup1">
                     <div class="row">
                        <div class="col-md-4">
                           <div class="ceh-testo-image"><img src="/assets/images/testo.jpg" class="img-fluid" alt="t1">
                           </div>
                        </div>
                        <div class="col-md-8">
                           <div class="ceh-testo-cont">
                              ...
                              <div class="ceh-testo-body">
                                 <p>Fresh-Net has a way of changing my perspective so that life's possibilities open up
                                    tremendously
                                    when I work with them. It feels great having when someone listens to you and helps
                                    you figure out
                           ...
                           <div class="col-md-4">
                              <div class="template15-wrap-main">
                                 ...
                                 <div class="template15-wrap-main-content">
                                    ...
                                    <p>
                                       Offers buffey of security programs, tools and techniques that are globally
            ...
            <div class="col-md-8">
               <div class="box-desccareer12">
                  ...
                  <p>At Cybar Wind, we acknowledge and value our differences as well as our combined strengths. We
                     ...
                     that inspires new ideas, promotes ownership and experimentation, and supports highly-motivated
                     individuals to be truly creative.
                  </p>
                  <p>We always believe in deliver quality through deep specialization and innovation. We hire people who
            ...
            <div class="col-md-4">
               <div class="box-wrappercareer12">
                  ...
                  <div class="box-button-career">
                        <a href="https://www.cybarwind.com/new-demo/asaraf/codec/careers.php" target="_blank">Join Our
                        Team</a>
                  </div>
               </div>
            </div>
   ...
   <section>
      <div class="coach">
         <div class="coach-img"> <img src="/assets/images/career-opportunities.jpg" class="img-fluid" alt="coach image">
         </div>
         <div class="coach-text">
            <h3>Career Opportunities. <br></h3>
            <h4>Explore opportunities at forefront of innovation</h4>
            <p>We bring together the best and the brightest in the industry to solve transformative cases with Data.</p>
