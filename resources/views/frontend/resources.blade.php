							...
							<div class="entry-wrapper row">
								<div class="entry-cover col-sm-4 col-xs-4">
									<a href="{{ route ('resources-view') }}"><img
											src="assets/images/vapt-services.jpg"
											class="img-fluid" alt="">
									</a>
								</div>
								<div class="col-sm-8">
							...
							<div class="entry-wrapper row">
								...
								<div class="col-sm-8 col-xs-8">
									<div class="entry-header">
										<p><i class="fa fa-caret-right" aria-hidden="true"
												style="color:green;"></i>&nbsp;
											<a href="{{ route ('resources-view') }}">What is Agile and Scrum Methodology?</a>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="entry-wrapper row">
								...
								<div class="col-sm-8 col-xs-8">
									<div class="entry-header">
										<p><i class="fa fa-caret-right" aria-hidden="true"
												style="color:green;"></i>&nbsp;
											<a href="{{ route ('resources-view') }}">What Is Agile Project Management?</a>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="entry-wrapper row">
								...
								<div class="col-sm-8 col-xs-8">
									<div class="entry-header">
										<p><i class="fa fa-caret-right" aria-hidden="true"
												style="color:green;"></i>&nbsp;
											<a href="{{ route ('resources-view') }}>javaaa</a>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="entry-wrapper row">
								...
								<div class="col-sm-8 col-xs-8">
									<div class="entry-header">
										<p><i class="fa fa-caret-right" aria-hidden="true"
												style="color:green;"></i>&nbsp;
											<a href="{{ route ('resources-view') }}">Free eBook: Agile and Scrum Salary Report</a>
										</p>
									</div>
								</div>
							</div>
