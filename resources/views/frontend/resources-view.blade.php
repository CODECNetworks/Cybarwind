                ...
                <div class="col-sm-4">
                    <div class="offer-sec-inn rv-space" id="rv4">
                        ...
                        <div class="view_blog view_blog1 resouces-right">
                            <h4 class="btm-bdr">Top Trending Resources</h4>
                            <ul>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">python</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">WDFSDFDSFSDF</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">What is Agile and Scrum Methodology?</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">ZXCSDFS</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">What Is Agile Project Management?</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route ('resources-view') }}">Geolocations</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">javaaa</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">php</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">asdasdasd</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">Free eBook: Agile and Scrum Salary Report</a></li>
                                <li><i class="fa fa-caret-right" aria-hidden="true"></i> <a
                                        href="{{ route('resources-view') }}">richgghh</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="assets/js/common.js?v-2"></script>
