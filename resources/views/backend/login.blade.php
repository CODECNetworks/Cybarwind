...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets2/vendor/@fortawesome/fontawesome-free/css/all.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
...
.page-message {
    ...
    <main class="auth">
			  ...
			  <div class="page-message" role="alert" style="display: flex;">
				   <a href="#" class="btn btn-sm btn-icon btn-warning ml-1" aria-label="Close" onclick="$(this).parent().fadeOut()" style="margin-left: 15px !important;"><span aria-hidden="true" ><i class="fa fa-times"></i></span></a>
			  </div>
		
		
      <header id="auth-header" class="auth-header" style="background-image: url(assets2/images/illustration/img-1.png);">
	  ...
	  <form class="auth-form"  action="" method="post">
        ...
        <div class="form-group">
          <div class="form-label-group">
            <input type="text" id="inputUser" name="username"  class="form-control cards" placeholder="Username" autofocus="" required> <label for="inputUser">Username</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
          <div class="form-label-group">
            <input type="password" id="inputPassword" name="password" class="form-control cards" placeholder="Password" required> <label for="inputPassword">Password</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
