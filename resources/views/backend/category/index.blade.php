        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                ...
                <div class="table-responsive">
                    <table id="brandsTable" class="table table-striped table-bordered  w-100">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="list-icon-function">
                                                ...
                                                <a href="{{ route('resources-category.edit', $brand->id) }}">
                                                    <div class="item edit">
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('resources-category.destroy', ':id') }}".replace(':id',
                                brandId),
                            method: "DELETE",
                            data: {
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.show', function() {
                ...
                $.ajax({
                    url: "{{ route('resources-category.show', ':id') }}".replace(':id', brandId),
                    method: "GET",
                    success: function(response) {
