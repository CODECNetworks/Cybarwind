...
<<<<<<< HEAD:resources/views/backend/resource/create.blade.php
#imgpreview img {
    max-width: 100%;
    height: auto;
    border-radius: 5px;
...
>>>>>>> 07aaf42f9145395a3ca9b7e25d9a14982a7e74e0:resources/views/backend/resources/create.blade.php
        ...
        <div class="wg-box">
            <form class="form-new-brand form-style-1" action="{{ route('resources.store') }}" method="POST"
                ...
                <fieldset class="description">
                    ...
                    <textarea class="summernote flex-grow" name="description" placeholder="Enter description here"
                        tabindex="0" required></textarea>
                </fieldset>
