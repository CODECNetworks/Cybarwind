                            ...
                            @if ($resources->count() > 0)
                                @foreach ($resources as $resource)
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Short description (manually shortened) -->
                                            <span class="description-short">
                                                {!! mb_strimwidth($resource->description, 0, 100, '...') !!}
                                            </span>
                                        
                                            <!-- Read More button for longer descriptions -->
                                            @if(strlen($resource->description) > 100)
                                                <button class="btn btn-link read-more" data-id="{{ $resource->id }}" data-description="{{ $resource->description }}">Read More</button>
                                            @endif
                                        </td>
